...
rm(attributes, chemistry3, macroCounts2, micro2)
```
...
# write.csv(fishCounts2,file = "data/fishCounts2.csv")
# write.csv(chemistry3,file = "data/chemistry3.csv")
# O2Dis pH SpCond Turbidity WaterTemp
# allData <- suppressMessages(read_csv(file = "data/allData.csv"))
# allData <- allData[,-1]
# fishCounts2 <- suppressMessages(read_csv(file = "data/fishCounts2.csv"))
# fishCounts2 <- fishCounts2[,-1]
# chemistry3 <- suppressMessages(read_csv(file = "data/chemistry3.csv"))
# chemistry3 <- chemistry3[,-1]
```
